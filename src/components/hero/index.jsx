    ...
    <div className="max-w-[1110px] mx-auto px-[16px] xl:px-0 mt-[20px]">
      <div className="relative hidden md:flex items-center justify-between h-[455px] rounded-[24px] bg-light-grey -z-10">
        <div className="w-[500px] lg:w-[680px] ml-[40px] xl:ml-[66px] my-[24px] xl:my-[44px]">
          <h1 className="text-[32px]/[37px] lg:text-[44px]/[49px] font-[600]">
            SEEDRA Basil Seeds for Indoor and Outdoor Planting
          </h1>
          <p className="my-[12px] font-[400]">
          ...
          <div className="flex gap-[40px]">
            <p className="flex items-center gap-[10px]">
              <AiFillFire className="text-danger text-[32px] lg:text-[42px]" />{" "}
              <b className="text-[32px] lg:text-[42px]">$12.56</b>{" "}
              <span className="ml-[10px] text-[20px] text-text-secondary line-through">
                $15.56
              </span>
            </p>
          </div>
      ...
      <div className="block md:hidden rounded-[24px] bg-light-grey overflow-hidden">
        ...
        <div className="flex gap-[40px] px-[16px]">
          <p className="flex items-center gap-[10px]">
            <AiFillFire className="text-danger text-[28px]" />{" "}
            <b className="text-[28px] text-danger">$12.56</b>{" "}
            <span className="ml-[10px] text-[20px] text-text-secondary line-through">
              $15.56
            </span>
          </p>
        </div>
        <h1 className="text-[24px]/[29px] font-[600] my-[10px] px-[16px]">
          SEEDRA Basil Seeds for Indoor and Outdoor Planting
        </h1>
        <p className="my-[12px] font-[400] px-[16px]">
      ...
      <div className="flex items-center justify-center md:justify-between bg-[#FFE62E17] rounded-[12px] mt-[20px] text-center p-[15px]">
